                        ...
                        <div class="masthead__content">
                            ...
                            <div data-anim-child="slide-up delay-3" class="masthead-info row y-gap-15 sm:d-none">
                                ...
                                <div class="masthead-info__item d-flex items-center text-white">
                                    ...
                                    <div class="masthead-info__title lh-1">Certified Professionals</div>
                                </div>
                                ...
                                <div class="masthead-info__item d-flex items-center text-white">
                                    ...
                                    <div class="masthead-info__title lh-1">Quality Service</div>
                                </div>
                    ...
                    <div data-anim-child="slide-up delay-5" class="col-xl-6 col-lg-6">
                        <div class="masthead-image">
                            <div class="masthead-image__el1">
                                <img class="gg-masthead-1" data-move="40" src="assets/img/psc/gg-portrait.jpeg" alt="image">

                                <div data-move="30" class="lg:d-none img-el -w-250 px-20 py-20 d-flex items-center bg-white rounded-8">
                                    <div class="size-50 d-flex justify-center items-center bg-red-2 rounded-full">
                                        <img src="assets/img/masthead/1.svg" alt="icon">
                                    </div>
                                    <div class="ml-20">
                                        <div class="text-orange-1 text-16 fw-500 lh-1">50 +</div>
                                        <div class="mt-3">Training Events</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="masthead-image__el3">
                                ...
                                <div data-move="30" class="shadow-4 img-el -w-260 px-30 py-20 d-flex items-center bg-white rounded-8">
                                    ...
                                    <div class="">
                                        <div class="text-purple-1 text-16 fw-500 lh-1">Certified!</div>
                                        <div class="mt-3">Professional Experience</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="layout-pt-md layout-pb-md">
            <div data-anim-wrap class="container">
                ...
                <div class="row pt-60 lg:pt-40">
                    <div class="col-12">
                        <p>Permanent Success consultancy was founded and kicked off its activities in 2020, with an aim of providing long lasting solutions to individuals and institutions through comprehensive training programs.</p>
                        <p class="mt-20">Our S.M.A.R.T training programs have been able to help individuals and institutions get the best out of their employees, acquire more customers as they  advance in business growth and development.
                            We strive to create  self-sustaining institutions that focuses on growth by investing more in their employees.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row y-gap-30 justify-between items-center">
                    <div class="col-xl-5 col-lg-6 col-md-10 order-2 order-lg-1">
                        <div class="about-content">
                            <h2 data-anim-child="slide-up delay-1" class="about-content__title"><span>Four areas</span> that we focus on.</h2>
                            <p data-anim-child="slide-up delay-2" class="about-content__text">We are determined to create a culture and values that drive collective change and responsibility in four areas:</p>
                            <div data-anim-child="slide-up delay-3" class="y-gap-20 pt-30">
                                <div class="d-flex items-center">
                                    ...
                                    <div class="about-content-list__title">Customer Service/Experience</div>
                                </div>
                                ...
                                <div class="d-flex items-center">
                                    ...
                                    <div class="about-content-list__title">Quality Leadership and management</div>
                                </div>
                                ...
                                <div class="d-flex items-center">
                                    ...
                                    <div class="about-content-list__title">Employee Productivity  and,</div>
                                </div>
                                ...
                                <div class="d-flex items-center">
                                    ...
                                    <div class="about-content-list__title">Team Building activities.</div>
                                </div>

                            </div>

                            <div data-anim-child="slide-up delay-4" class="d-inline-block mt-30">
                                <a href="about-us" class="button -md -dark-1 text-white">More Info</a>
                            </div>
                        </div>
                    </div>
